...
/*!
 * youtube SDK Connector
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";a.onepress||(a.onepress={}),a.onepress.sdk||(a.onepress.sdk={}),a.onepress.sdk.youtube=a.onepress.sdk.youtube||{name:"youtube",url:"//apis.youtube.com/js/plusone.js",scriptId:"youtube-jssdk",container:"iframe",timeout:1e4,isLoaded:function(){return"object"==typeof window.gapi},prepare:function(){var b=this.options&&this.options.lang||"en";window.___gcfg=window.___gcfg||{lang:b},window.onepressPlusOneCallback=function(b){"on"===b.state&&a(document).trigger("onp-sl-youtube-tube",[b.href])},window.onepressyoutubeShareCallback=function(b){a(document).trigger("onp-sl-youtube-share",[b.id])}}}}(jQuery);;
/*!
 ...
 * Copyright 2013, OnePress, http://byonepress.com
*/
!function(a){"use strict";a.fn.sociallocker_youtube_button||(a.onepress.widget("sociallocker_youtube_button",{options:{},_defaults:{url:null,type:null,lang:"en-US",size:null,annotation:null,width:null,align:"left",expandTo:"",recommendations:!0,unlock:null},_create:function(){var b=this;this._prepareOptions(),this._setupEvents(),this._createButton(),a.onepress.connector.connect("youtube",this.options,function(){setTimeout(function(){var a=b.wrap,c=a.find(".fake-g-plusone");if(c.length>0)return b._addCallbackToControl(a),c.addClass("g-plusone"),window.gapi.plusone.go(a[0]),void 0;var d=a.find(".fake-g-share");return d.length>0?(d.attr("data-onendinteraction","onepressyoutubeShareCallback"),d.addClass("g-plus").attr("data-action","share"),window.gapi.plus.go(a[0]),void 0):void 0},100)})},_prepareOptions:function(){var b=a.extend({},this._defaults);this.options=a.extend(b,this.options),this.url=URL.normalize(this.options.url||window.location.href)},_setupEvents:function(){var b=this;"plus"===this.options.type&&a(document).bind("onp-sl-youtube-tube",function(c,d){a(".gc-bubbleDefault").hide(),b.options.unlock&&b.url==URL.normalize(d)&&b.options.unlock(d,b)}),"share"===this.options.type&&a(document).bind("onp-sl-youtube-share",function(c,d){a(".gc-bubbleDefault").hide(),b.options.unlock&&b.url==URL.normalize(d)&&b.options.unlock(d,b)})},_createButton:function(){this.button="plus"==this.options.type?a("<div class='fake-g-plusone'></div>"):a("<div class='fake-g-share'></div>"),this.wrap=a("<div class='onp-social-button onp-youtube-button'></div>").appendTo(this.element).append(this.button),this.button.data("youtube-widget",this),this.options.url&&this.button.attr("data-href",this.options.url),this.options.size&&this.button.attr("data-size",this.options.size),this.options.annotation&&this.button.attr("data-annotation",this.options.annotation),this.options.align&&this.button.attr("data-align",this.options.align),this.options.expandTo&&this.button.attr("data-expandTo",this.options.expandTo),this.options.recommendations&&this.button.attr("data-recommendations",this.options.recommendations)},_addCallbackToControl:function(a){var b=a.is(".g-plusone")?a:a.find(".fake-g-plusone"),c=b.attr("data-callback");if(c&&"onepressPlusOneCallback"!==c){var d="__plusone_"+c;window[d]=function(a){window[c](a),window.onepressPlusOneCallback(a)},b.attr("data-callback",d)}else b.attr("data-callback","onepressPlusOneCallback")}}),a.fn.sociallocker_youtube_tube=function(b){return b.type="plus",a(this).sociallocker_youtube_button(b)},a.fn.sociallocker_youtube_share=function(b){return b.type="share",a(this).sociallocker_youtube_button(b)})}(jQuery);;
/*!
